...
from finrl.constants import ListPairsWithTimeframes, PairWithTimeframe
from finrl.data.history import load_pair_history
from finrl.exceptions import ExchangeError, OperationalException
...
class DataProvider:
    ...
    def refresh(self,
                ...
                helping_pairs: ListPairsWithTimeframes = None,
               ) -> None:
        """
