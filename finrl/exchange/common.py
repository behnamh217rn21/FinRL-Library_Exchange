...
from finrl.exceptions import DDosProtection, RetryableOrderError, TemporaryError
...
BAD_EXCHANGES = {"bitmex": "Various reasons.",
                 "bitstamp": "Does not provide history. ",
                 "hitbtc": "This API cannot be used. "
...
MAP_EXCHANGE_CHILDCLASS = {'binanceus': 'binance',
                           'binanceje': 'binance',
                          }
